...
SECRET_KEY = 'hpu(@ol4q8qu+)4lw^fl5rsh(mmc2z0-d92$e&3ms4&s_*$&nv'
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware', # cors 는 반드시 CommonMiddleware 위에 추가
